    ...
    <div className="pt-1 bg-gray-100">
      <section className="max-w-5xl mx-auto">
        ...
        <h1 className="text-5xl font-semibold text-gray-400 my-16 max-w-3xl">
          <span className="text-black">Store.</span> The best way to buy the products you love
        </h1>
        ...
        <div className="card-gallery">
          <h1 className="text-3xl font-medium text-gray-400 mt-16 max-w-3xl">
            <span className="text-black">The latest.</span> Take a look at what’s new, right now.
          </h1>
        </div>
