function NotFound(props) {
    return (
        <div className="max-w-xl mx-auto h-screen flex flex-col items-center justify-center text-center">
            ...
            <input className="w-96 mt-10 border-2 p-3 rounded focus:border-blue-400" type="text" placeholder="Search apple.com"/>
            <a className="mt-6 text-blue-400" href="https://google.es">Or see our site map</a>
        </div>
    );
}
