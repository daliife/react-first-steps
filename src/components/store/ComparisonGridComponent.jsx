...
const ComparisonGridComponent = () => {
  const dummyGridData = [
    {
      title: 'Macbook Air',
      computerImage: 'https://www.apple.com/v/mac/home/bj/images/overview/compare/compare_mba__fchj615oz0yi_large.png',
      price: 'From 999$',
      stats: [
        {
          title: '8-core1',
  ...
  return (
    <div className="mt-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        {dummyGridData.map((item, index) => (
          <div key={item.title + index} className="flex flex-col items-center">
            <img className="max-h-28" src={item.computerImage} alt={item.title} />
            ...
            <a className="text-blue-500 text-sm hover:underline flex justify-center items-center" href={item.title}>
              Learn more
        ...
        {dummyGridData.map((item) =>
          item.stats.map((element) => (
            <div className="text-center my-3">
              ...
              <p className="font-light text-sm text-gray-500">{element.description}</p>
            </div>
          )),
        )}
      </div>
      ...
      <div className="links mt-8 mb-4 flex gap-8 items-center justify-center">
        <a className="text-blue-500 font-light text-xl flex flex-row items-center" href="https://google.es">
